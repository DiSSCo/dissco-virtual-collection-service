...
public class TestUtils {
	...
	public static VirtualCollectionEvent givenVirtualCollectionEvent(VirtualCollectionAction action) {
		return new VirtualCollectionEvent(action, givenVirtualCollection());
	}
	...
	public static TargetDigitalObjectFilter givenTargetDigitalObjectFilter() {
		return new TargetDigitalObjectFilter().withOdsPredicateType(OdsPredicateType.EQUALS)
	...
	public static TargetDigitalObjectFilter givenNotFilter() {
		return new TargetDigitalObjectFilter().withOdsPredicateType(OdsPredicateType.NOT)
	...
	public static TargetDigitalObjectFilter givenInFilter() {
		return new TargetDigitalObjectFilter().withOdsPredicateType(OdsPredicateType.IN)
	...
	public static TargetDigitalObjectFilter givenOrFilter() {
		return new TargetDigitalObjectFilter().withOdsPredicateType(OdsPredicateType.OR)
			.withOdsHasPredicates(List.of(
					new OdsHasPredicate().withOdsPredicateType(OdsHasPredicate.OdsPredicateType.EQUALS)
						.withOdsPredicateKey("$['ods:topicDiscipline']")
	...
	public static TargetDigitalObjectFilter givenAndFilter() {
		return new TargetDigitalObjectFilter().withOdsPredicateType(OdsPredicateType.AND)
			.withOdsHasPredicates(List.of(
					new OdsHasPredicate().withOdsPredicateType(OdsHasPredicate.OdsPredicateType.EQUALS)
	...
	public static Stream<Arguments> illegalFilters() {
		return Stream.of(
				...
				Arguments.of(new TargetDigitalObjectFilter().withOdsPredicateType(OdsPredicateType.NOT)
					.withOdsPredicateKey("$['ods:topicDiscipline']")
					.withOdsPredicateValues(List.of("botany", "zoology"))),
				Arguments.of(new TargetDigitalObjectFilter().withOdsPredicateType(OdsPredicateType.IN)
					.withOdsPredicateKey("$['ods:topicDiscipline']")
				...
				Arguments
					.of(new TargetDigitalObjectFilter().withOdsPredicateType(OdsPredicateType.EQUALS)
	...
	public static Query givenElasticQuery() {
		return new Query.Builder().bool(b -> b.must(new Query.Builder()
			.term(t -> t.field("@id.keyword").value(FieldValue.of(SPECIMEN_ID)).caseInsensitive(true))
			.build())).build();
	}
	...
	public static DigitalSpecimenEvent givenDigitalSpecimenEventWithVC(boolean isDataFromSourceSystem) {
		return new DigitalSpecimenEvent(Collections.emptySet(),
				new DigitalSpecimenWrapper("https://herbarium.bgbm.org/object/B100039428",
						"https://doi.org/21.T11148/894b1e6cad57e921764e", givenDigitalSpecimenWithVC(), null),
				Collections.emptyList(), false, isDataFromSourceSystem);
	}
	...
	public static DigitalSpecimen givenDigitalSpecimenWithVC() {
		...
		digitalSpecimen.getOdsHasEntityRelationships()
			.add(new EntityRelationship().withType("ods:EntityRelationship")
				...
				.withOdsHasAgents(List.of(new Agent().withId(APP_ID)
					.withType(Type.SCHEMA_SOFTWARE_APPLICATION)
					.withSchemaName(APP_NAME)
					.withOdsHasRoles(List
						.of(new OdsHasRole().withType("schema:Role").withSchemaRoleName("virtual-collection-manager")))
					.withOdsHasIdentifiers(List.of(new Identifier().withId(APP_ID)
						...
						.withOdsGupriLevel(OdsGupriLevel.GLOBALLY_UNIQUE_STABLE_PERSISTENT_RESOLVABLE_FDO_COMPLIANT)
