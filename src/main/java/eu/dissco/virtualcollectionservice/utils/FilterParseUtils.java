...
public class FilterParseUtils {
	...
	public static List<Object> harmonizeValues(Object odsPredicateValue, List<Object> odsPredicateValues) {
		if (odsPredicateValue != null) {
			...
			throw new IllegalArgumentException("Both predicate value and predicate values are null or empty");
		}
	}
